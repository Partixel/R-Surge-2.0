return {
	...
	BulletType = { Name = "Lightning" },
	
	Damage = 10, -- Damage of the gun
	
	FireRate = 7, -- How many clicks will be handled in a second
	
	MaxAmmo = 22, -- The max ammo the gun has, -1 is infinite
	
	ReloadAmount = 11, -- The amount that will be reloaded at a time ( Will reload from a multiple of this, e.g. 22 MaxAmmo, 11 ReloadAmount, 20 ammo when reloading will result in ammo being set to 11 and then after half the ReloadDelay will be filled )
