...
local MinY = 0.5
Core.Events.DirectionalDamageIndicator = Core.ClientDamage.OnClientEvent:Connect(function(DamageSplits, Str, ExtraInformation)
	if type(Str) == "string" and Enabled and ExtraInformation.StartPosition then
