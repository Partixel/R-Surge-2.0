...
Core.Visuals.ShotKnockback = Core.ServerVisuals.Event:Connect( function ( StatObj, _, Barrel, Hit, End )
	...
	local Velocity = CFrame.new( Barrel.Position, End ).lookVector * GunStats.Damage * ( ( GunStats.Range - ( End - Barrel.Position ).magnitude ) / GunStats.Range ) * Config.ShotKnockbackPercentage * Vector3.new( 1, 0, 1 ) * ( GunStats.Knockback or 1 )
